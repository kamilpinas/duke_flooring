        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-400 font-serif">
              Your trusted, family-owned partner for artisan flooring in Lake
              County and the surrounding areas. We're committed to bringing quality,
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li className="flex items-start">
                ...
                <span>Lake County, IL, United States</span>
              </li>
