  ...
  const slides = [
    {
      ...
      description:
        "Artisan craftsmanship for your home in Chicagoland, IL. We specialize in LVP, hardwood, laminate, carpet, and ceramic tile flooring, along with expert subfloor preparation, combining timeless beauty with modern durability.",
    },
    {
