  ...
  return (
    <main>
      <SEO
        ...
        description="View our portfolio of stunning flooring transformations across Lake County and the surrounding areas. See before & after pictures of our hardwood, LVP, and laminate installations."
